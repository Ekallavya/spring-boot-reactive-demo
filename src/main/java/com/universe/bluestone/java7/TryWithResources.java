package com.universe.bluestone.java7;
...
public class TryWithResources {
	public static void main(String args[]) {
		...
		try ( // Using multiple resources
				FileOutputStream fileOutputStream = new FileOutputStream("/AdvancedJava/src/abc.txt");
				InputStream input = new FileInputStream("/AdvancedJava/src/abc.txt")) {
